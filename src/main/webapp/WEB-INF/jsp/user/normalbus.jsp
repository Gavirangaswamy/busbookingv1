...
<div class="container1">
  ...
  <form action="bookingprocess">
   <div class="item">
		<label for="type">Pick Up</label><br> <select id="pickup" name="pickup" required="required">
			<option></option>
    ...
    <input type="hidden" value="" id="totalcount" name = "totalcount" min="1" required="required">
