...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><b><a href="displayBuses">Back <ion-icon
    ...
    <div class="testbox">
        <form action="updateBus" method="post">
            ...
            <H6 class="top-info">Update The Following details to Update</H6><br><br>
            <div class="item">
					<p>
						Bus ID<span class="required">*</span>
					</p>

					<div class="name-item">
						<input type="text" name="id" placeholder="Enter Bus Id"
							value="${bus.id}" readonly />
					</div>
				...
				<div class="name-item">
					<input type="text" name="busRegNo"
						placeholder="Enter Bus Register Number" value="${bus.busRegNo}"
						required />
				</div>
                <div class="item">
					<p>
					...
					<input type="datetime-local" name="createdAt" required
						value="${bus.createdAt}" /> <i class="fas fa-calendar-alt"></i>
				</div>
                <br>
                <div class="item">
					<p>
					...
					<input type="datetime-local" name="updatedAt" required
						value="${bus.updatedAt}"> <i class="fas fa-calendar-alt"></i>
				</div>
            </div>
            <br>
            <div class="question">
                ...
                <div class="name-item">
                    <select id="type" name="busType" class="busType" onchange="seatsStep()">
            			<option value="${bus.busType}" disabled selected >${bus.busType}</option>
                ...
                <div class="name-item">
                    <input type="number" name="no_of_seats"
                           placeholder="Enter Number Of Seats" id="numbers" value="${bus.no_of_seats}">
                </div>
            </div>
            <br>
            <div class="btn-block">
                <button type="submit" href="/">Update Bus</button>
