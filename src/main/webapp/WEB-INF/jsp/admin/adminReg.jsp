...
<head>
    ...
    <link rel="stylesheet" href="css/adminRegStyles.css">
...
<section id="title">
    ...
    <center>${message}</center>
        ...
        <form action="adminReg" method="post">
            ...
            <p>First Name</p>
            <input type="text" pattern="^[A-Za-z]+$" title="please enter alphabets only (minimum 4 characters)"  minlength="4" name="first_name" placeholder="Enter first name (Alphabets)"
                   required/>
            <p>Last Name</p>
            ...
            <div>
                <input type="submit" value="Register"/> <a href="showLoginPage">Already
