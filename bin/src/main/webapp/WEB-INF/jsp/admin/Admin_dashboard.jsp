...
<nav class="navbar navbar-expand-lg nav bar-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item"><b><a href="index.html">HOME
                <ion-icon name="home"></ion-icon></b></a></li>
            <li class="nav-item"><b><a href="index.html">logout<i class="fa-solid fa-right-from-bracket"></i></b></a>
            </li>
        </ul>
    </div>
</nav>
...
<footer id="footer">
    ...
    <p><ion-icon name="help-circle"></ion-icon> Copyright 2022 <a href="https://dxc.com/in/en">DXC Technology</a></p>
</footer>
