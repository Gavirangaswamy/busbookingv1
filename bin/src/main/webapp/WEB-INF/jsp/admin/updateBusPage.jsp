				...
				<div class="item">
					...
					<div class="name-item">
						<input type="number" name="no_of_seats"
							placeholder="Enter Number Of Seats" value="${bus.no_of_seats}">
					</div>
